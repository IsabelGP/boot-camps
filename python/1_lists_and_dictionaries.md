...
If you are hopelessly stuck, then there is an example script available in [1c/drawTwoTriangles.py](https://github.com/davidglo/boot-camps/blob/2017-TMCS-software/Python/1c/drawTwoTriangles.py)
